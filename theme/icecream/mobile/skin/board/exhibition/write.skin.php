...
<section id="bo_w">
    ...
    if ($is_notice || $is_html || $is_secret || $is_mail) {
        $option = '';
        if ($is_notice) {
            $option .= PHP_EOL.'<input type="checkbox" id="notice" name="notice" value="1" '.$notice_checked.' style="display:none">'.PHP_EOL.'<label for="notice" style="display:none">공지</label>';
        }
        ...
        if ($is_html) {
            if ($is_dhtml_editor) {
                ...
                $option .= PHP_EOL.'<input type="checkbox" id="html" name="html" onclick="html_auto_br(this);" style="display:none" value="'.$html_value.'" '.$html_checked.'>'.PHP_EOL.'<label for="html" style="display:none">html</label>';
            }
        }
        ...
        <div class="row col-2">
            ...
            <div class="col">
                <div class="bo_w_tit write_div">
                    ...
                    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input full_input" placeholder="아호(한자)">
                </div>
            </div>
        </div>
        <div class="row col-3">
            ...
            <div class="col">
                <div class="bo_w_tit write_div">
                    ...
                    <input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_4" class="frm_input full_input" placeholder="출생년도">
                </div>
            </div>
            <div class="col">
                <div class="bo_w_tit write_div">
