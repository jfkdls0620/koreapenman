...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            ...
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="자격증 이름">
        </div>
        <div class="bo_w_tit write_div">
            <label for="wr_1" class="sound_only"><strong>필수</strong></label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" placeholder="자격의 등급">
        </div>
        <div class="bo_w_tit write_div">
            <label for="wr_2" class="sound_only"><strong>필수</strong></label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" placeholder="등록번호">
        </div>

        <div class="bo_w_tit write_div">
            <label for="wr_3" class="sound_only"><strong>필수</strong></label>
            <input type="text" name="wr_3" value="<?php echo $wr_3  ?>" id="wr_3" required class="frm_input full_input required" placeholder="발행기관">
        </div>
