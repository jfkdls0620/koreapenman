...
<!--        </ul>-->
        ...
        <ul class="div-table_tbody">
            ...
            <li class="<?php if ($thumb) echo "bo_liimg "; ?><?php if ($list[$i]['is_notice']) echo " bo_notice"; ?>">
                <div class="sub04"><?php echo $list[$i]['wr_4']?></div>
                ...
                <div class="grade"><?php echo $list[$i]['wr_3']?></div>
                <div class="sub05"><?php echo $list[$i]['wr_5']?></div>
            </li><?php } ?>
            <?php if (count($list) == 0) { echo '<li class="empty_table">등록된 명인명장이 없습니다.</li>'; } ?>
        </ul>
    </div>
