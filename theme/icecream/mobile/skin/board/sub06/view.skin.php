            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <span>
                             <?php
                             echo cut_str(get_text($view['wr_10']), 70);  // 아호 출력
                             ?>
                            <?php
                ...
                <tr>
                    ...
                    <td>
                        <span>
                            <?php echo cut_str(get_text($view['wr_3']), 70);  // 소속 ?>
                        </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span>
                            <?php echo cut_str(get_text($view['wr_6']), 70);  // 주소 ?>
                        </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span>
                            <?php echo cut_str(get_text($view['wr_7']), 70);  // 연락처 ?>
                        </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span>
                            <?php echo cut_str(get_text($view['wr_8']), 70);  // 이메일 ?>
                        </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <span>
                            <?php echo cut_str(get_text($view['wr_9']), 70);  // 홈페이지 ?>
                        </span>
                    </td>
                </tr>
            </table>
