...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        */
        ...
        <div class="bo_w_tit write_div">
            <label for="wr_1" class="sound_only">취득년도</label>
            <input type="text" name="wr_1" value="<?php echo $write[wr_1] ?>" id="wr_1" class="frm_input full_input" placeholder="취득년도">
        </div>

        <div class="bo_w_tit write_div">
            <label for="wr_2" class="sound_only">아호</label>
            <input type="text" name="wr_2" value="<?php echo $write[wr_2] ?>" id="wr_2" class="frm_input full_input" placeholder="아호">
        </div>

        <div class="bo_w_tit write_div">
            <label for="wr_3" class="sound_only">발행번호</label>
            <input type="text" name="wr_3" value="<?php echo $write[wr_3] ?>" id="wr_3" class="frm_input full_input" placeholder="발행번호">
        </div>

        <div class="bo_w_tit write_div">
            <label for="wr_4" class="sound_only">분야</label>
            <input type="text" name="wr_4" value="<?php echo $write[wr_4] ?>" id="wr_4" class="frm_input full_input" placeholder="분야">
        </div>
        <div class="bo_w_tit write_div">
            <label for="wr_5" class="sound_only">급수</label>
            <input type="text" name="wr_5" value="<?php echo $write[wr_5] ?>" id="wr_5" class="frm_input full_input" placeholder="급수">
        </div>
        <div class="bo_w_tit write_div">
            <label for="wr_6" class="sound_only">비고</label>
            <input type="text" name="wr_6" value="<?php echo $write[wr_6] ?>" id="wr_6" class="frm_input full_input" placeholder="비고">
        </div>
