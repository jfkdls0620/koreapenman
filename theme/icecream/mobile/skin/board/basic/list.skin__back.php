    ...
    <div class="board_list">
        ...
        <div class="div_table">
            <div class="tr tr_title">
                ...
                <div class="td">날짜</div>
                <div class="td">조회수</div>
            </div>
            <?php
            for ($i=0; $i<count($list); $i++) {
            ?>
                <div class="tr tr_list">
                    <div class="td">
                        <?php if ($is_checkbox) { ?>
                            <span class="bo_chk">
                    ...
                    <div class="td"><?php echo $list[$i]['name'] ?></div>
                    <div class="td"><?php echo $list[$i]['datetime2'] ?></div>
                    <div class="td"><?php echo number_format($list[$i]['wr_hit']) ?></div>
                </div>
            <?php } ?>
