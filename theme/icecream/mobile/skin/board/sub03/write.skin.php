...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            ...
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="구분">
        </div>

        <div class="bo_w_tit write_div">
            <p>분류</p>
            <label for="wr_1" class="sound_only"><strong>필수</strong></label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" placeholder="분류">
        </div>
